...
## We get the z-scores for loci relating to the ancestry trajectories
## calculate the p-values for loci
...
After converting the z-scores of loci to (q)p-values, we plot the manhattan plot to show the p-values.

```{r fig1, fig.height = 5, fig.width = 8.5, fig.align = "center"} 

## plot

 plot.manhattan(Hapmapqval$pvals$pvals$p.values,col=Hapmapqval$chr)

```

Fig.1 Manhattan plot of Hapmap dataset for detecting signals of local adaptation.
...
Fig.2 The ancestry admixture plot for Hapmap dataset.
